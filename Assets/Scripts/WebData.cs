...
public class WebData : MonoBehaviour
{
    ...
    private void TimeOneHandler(string text)
    {
        ...
        initSecondNumber = Data.SecondsSinceMidnight(_timeFromNet.hour, _timeFromNet.minute, _timeFromNet.seconds);
        ...
        Vector3Int _nextUploadTime = Data.SecToTime(nextUploadTime);
    ...
    private void TimeTwoHandler(string text)
    {
        ...
        initSecondNumber = Data.SecondsSinceMidnight(_timeFromNet.datetime.Split('T')[1].Split('+')[0].Split('.')[0]);
        int _parseRes;
    ...
    {
        initSecondNumber = Data.SecondsSinceMidnight(DateTime.Now.Hour, DateTime.Now.Minute, DateTime.Now.Second);
